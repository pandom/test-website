...
export declare class WizardDeprecated extends Tabs {
    private _scrollingService;
    id: string;
    wizardStepChildren: QueryList<WizardStep>;
    wizardPageChildren: QueryList<WizardPageDeprecated>;
    size: string;
    _open: boolean;
    closable: boolean;
    ...
    isLast: boolean;
    isFirst: boolean;
    currentPage: WizardPageDeprecated;
    ...
    readonly tabContents: WizardPageDeprecated[];
    open(): void;
    close(): void;
