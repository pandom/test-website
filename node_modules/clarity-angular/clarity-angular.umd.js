(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/forms'), require('@angular/core'), require('rxjs/Subject'), require('rxjs/BehaviorSubject'), require('@angular/animations'), require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/common', '@angular/forms', '@angular/core', 'rxjs/Subject', 'rxjs/BehaviorSubject', '@angular/animations', '@angular/platform-browser'], factory) :
    (factory((global.ng = global.ng || {}, global.ng.clarity = global.ng.clarity || {}),global.ng.common,global.ng.forms,global.ng.core,global.rxjs.Subject,global.rxjs_BehaviorSubject,global.ng.animations,global.ng.platformBrowser));
}(this, (function (exports,_angular_common,_angular_forms,_angular_core,rxjs_Subject,rxjs_BehaviorSubject,_angular_animations,_angular_platformBrowser) { 'use strict';
